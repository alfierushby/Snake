...
public class ImageUtil
{
	...
	static
	{
		...
		images.put("snake-head-right",
				GameUtil.getImage("/snake-head-right.png"));
		...
		images.put("10",
				GameUtil.getImage("/Food/food-grapefruit.png"));
		...
		images.put("14",
				GameUtil.getImage("/Food/food-pineapple.png"));
		images.put("15",
				GameUtil.getImage("/Food/food-strawberry.png"));
		images.put("16",
				GameUtil.getImage("/Food/food-watermelon.png"));
		images.put("UI-background",
				GameUtil.getImage("/UI-background.png"));
		images.put("game-scene-01",
				GameUtil.getImage("/game-scene-01.jpg"));
	}
}
